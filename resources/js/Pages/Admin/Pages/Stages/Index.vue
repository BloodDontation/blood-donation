                ...
                <div class="whitespace-nowrap overflow-x-auto">
                    ...
                    <table class="table w-full">
                        ...
                        <tr>
                            ...
                            <th class="px-4 py-3">{{trans('Prerequisite')}}</th>
                        ...
                        <tr class=""
                            ...
                            <td class="px-4 py-3">{{stages.type}}</td>

                            <td class="px-4 py-3">{{stages.prerequisite}}</td>

                            <td class="px-4 py-3">{{stages.description}}</td>
                            ...
                            <td>
                                ...
                                <div class="flex items-center text-sm space-x-4">
                                    ...
                                    <a
                                        :href="route('admin-stages-edit', {id: stages.id})"
                                        class="btn"
                                        aria-label="Edit">
