                                    ...
                                    <div class="flex flex-wrap form-control w-full px-2">
                                        ...
                                        <div class="flex items-center justify-between bg-grey-lighter p-2">
                                            <label class="w-36 h-36 flex flex-col items-center px-6 py-6 bg-white text-blue rounded-lg shadow-lg tracking-wide capitalize border border-blue cursor-pointer hover:border-white">
                                                ...
                                                <template v-if="campaign_form.logo">

                                                    <img :src="campaign_form.logo_url" class="w-full h-full object-contain" @error="HelperService.replace_by_default_img($event, 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSJycmP3sIPmwRmsf55XLjL0d_jKkpD2gTEALg6kTcfFS9v6Lfi9kSRJv1fLUuod7pMExU&usqp=CAU')">
                                ...
                                <div class="flex flex-wrap w-full md:w-10/12">
                                    ...
                                    <div class="flex form-control w-full md:w-1/2 px-2">
                                        ...
                                        <div class="relative">
                                            ...
                                            <input v-model="campaign_form.name"
                                    ...
                                    <div class="flex form-control w-full md:w-1/2 px-2">
                                        ...
                                        <div class="relative">
                                            ...
                                            <input v-model="campaign_form.location"
                                    ...
                                    <div class="flex form-control w-full md:w-1/2 px-2">
                                        ...
                                        <div class="relative">
                                            ...
                                            <input v-model="campaign_form.start_time"
                                    ...
                                    <div class="flex form-control w-full md:w-1/2 px-2">
                                        ...
                                        <div class="relative">
                                            ...
                                            <input v-model="campaign_form.end_time"
                                                type="datetime-local" class="w-full input input-bordered">
                                    ...
                                    <div class="flex form-control w-full md:w-1/2 px-2">
                                        ...
                                        <div class="relative">
                                            ...
                                            <input v-model="campaign_form.total_donor"
                                    ...
                                    <div class="flex form-control w-full md:w-1/2 px-2">
                                        ...
                                        <div class="relative">
                                            ...
                                            <input v-model="campaign_form.donor_per_period"
                                    ...
                                    <div class="flex form-control w-full px-2">
                                        ...
                                        <div class="relative">
                                            ...
                                            <textarea v-model="campaign_form.description"
                    ...
                    <div class="flex justify-end">
                        ...
                        <div class="mt-4">
                            ...
                            <button
                                type="submit"
                                class="btn"
                                :class="[ campaign_form.processing ? 'loading' : '']"
                                :disabled="campaign_form.processing"
                            >
                                {{trans('save')}}
                            </button>
    ...
    export default {
        ...
        data: function() {
            ...
            return {
                ...
                campaign_form: this.$inertia.form(this.campaign),
        ...
        mounted()
        {
            ...
            this.campaign_form.start_time    = moment(this.campaign_form.start_time).format('YYYY-MM-DD');
            this.campaign_form.end_time      = moment(this.campaign_form.end_time).format('YYYY-MM-DD');
        ...
        methods: {
            ...
            add_campaign: function () {
                ...
                this.campaign_form.transform(data => ({

                    ... data,

                }))
                .post(this.route('admin-campaigns-update'), {
            ...
            format_order_log_dates()
            {

                // format order log date
                this.order.order_logs.forEach(order_log => {
                    order_log.created_at_formatted = moment(order_log.created_at).format('YYYY-MM-DD HH:mm:ss');
                });
            ...
            select_item_file: function(event)
            {
                ...
                this.campaign_form.logo              = event.target.files[0];
                this.campaign_form.logo_url     = URL.createObjectURL(event.target.files[0]);
